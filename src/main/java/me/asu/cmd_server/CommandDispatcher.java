package me.asu.cmd_server;


import java.util.*;
import lombok.Data;
import me.asu.cmd_server.command.ExitCommand;
...
public class CommandDispatcher {
    ...
    private CommandDispatcher() {
        addCommand("quit", new me.asu.cmd_server.command.ExitCommand());
        addCommand(new ExitCommand());
        addCommand(new me.asu.cmd_server.command.AuthCommand());
        addCommand(new me.asu.cmd_server.command.HelpCommand());
        addCommand(new me.asu.cmd_server.command.CharsetCommand());
        addCommand(new me.asu.cmd_server.command.InputCharsetCommand());
        addCommand(new me.asu.cmd_server.command.EchoCommand());
        addCommand(new me.asu.cmd_server.command.JscCommand());
    }
